...
class _commentBoxState extends State<commentBox> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text("Comment Page", style: TextStyle(color: Colors.black),),
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [Color.fromARGB(255, 185, 193, 232), Color.fromARGB(255, 90, 113, 243)],
        ...
        child: CommentBox(
          userImage: CommentBox.commentImageParser(
              imageURLorPath: "https://cdn.pixabay.com/photo/2014/02/27/16/10/flowers-276014_1280.jpg"),
